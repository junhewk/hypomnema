...
class TestTriageDocument:
    @pytest.mark.asyncio
    async def test_bootstrap_accepts_all(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_relevant_document_accepted(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_irrelevant_document_rejected(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
    ...
    @pytest.mark.asyncio
    async def test_returns_true_on_accept(self, tmp_db, mock_embeddings) -> None:
        doc_id = await _insert_feed_doc(tmp_db, "bootstrap doc", doc_id="ret1")
        result = await triage_document(tmp_db, doc_id, mock_embeddings)
        assert result is True

    @pytest.mark.asyncio
    async def test_returns_false_on_reject(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
    ...
    @pytest.mark.asyncio
    async def test_sets_triaged_1_on_accept(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_sets_triaged_neg1_on_reject(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
    ...
    @pytest.mark.asyncio
    async def test_threshold_configurable(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
    ...
    @pytest.mark.asyncio
    async def test_high_threshold_rejects(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
    ...
    @pytest.mark.asyncio
    async def test_already_accepted_returns_true(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_already_rejected_returns_false(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stores_document_embedding(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_stores_embedding_even_on_reject(self, tmp_db, mock_embeddings) -> None:
        await _seed_engrams(tmp_db, mock_embeddings)
...
class TestTriagePendingDocuments:
    @pytest.mark.asyncio
    async def test_triages_all_pending(self, tmp_db, mock_embeddings) -> None:
        for i in range(3):
    ...
    @pytest.mark.asyncio
    async def test_filters_by_source_type(self, tmp_db, mock_embeddings) -> None:
    ...
    @pytest.mark.asyncio
    async def test_source_type_none_triages_all(self, tmp_db, mock_embeddings) -> None:
        await tmp_db.execute(
    ...
    @pytest.mark.asyncio
    async def test_skips_already_triaged(self, tmp_db, mock_embeddings) -> None:
